  ...
  <nav class="navbar navbar-toggleable-md fixed-top navbar-transparent landing-navbar">
    <div class="container">
      <div class="navbar-translate">
        ...
        <button class="navbar-brand landing-brand" type="button" @click="handleBrandClick">AI 智能行程规划引擎</button>
      </div>
        ...
        <ul class="navbar-nav ml-auto landing-nav">
          <li class="nav-item">
            <a
              ...
              href="https://github.com/1sdv/SheepTrip"
              target="_blank"
          ...
          <li class="nav-item">
            <button type="button" class="nav-link landing-nav-btn admin-btn" @click="goToAdmin" title="Admin">
              <svg width="18px" height="18px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M512 32a244.48 244.48 0 0 0-244.48 244.48v55.232C200.192 369.28 160 424.96 160 489.6v388.8A57.6 57.6 0 0 0 217.6 936h588.8a57.6 57.6 0 0 0 57.6-57.6V489.6c0-64.64-40.192-120.32-107.52-157.888V276.48A244.48 244.48 0 0 0 512 32zm157.44 345.6v157.44H354.56V377.6h314.88z"/></svg>
              Admin
            </button>
          </li>
          <li class="nav-item">
