...
const bgColor = computed(() => {
  ...
  return colors[props.item.name] || getDynamicColor(props.item.name)
})
...
const getDynamicColor = (name: string): string => {
  ...
  const colors = ['#2c3e50', '#8b4513', '#1e3a5f', '#2d5016', '#1a1a2e', '#1e3d5f', '#2c1810', '#0e4d64', '#5c4033', '#1b2d37']
